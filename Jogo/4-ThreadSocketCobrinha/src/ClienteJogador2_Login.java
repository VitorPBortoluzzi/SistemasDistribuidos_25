...
public class ClienteJogador2_Login extends javax.swing.JFrame {
    ...
    private void jButton_ConectarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ConectarActionPerformed
        ...
        try {
            // Tenta obter a porta (com tratamento de erro básico)
            porta = Integer.parseInt(jTextField_Porta.getText());

            // 1. ESTABELECE A CONEXÃO
            socket = new Socket(ip, porta);

            // 2. CRIA OS STREAMS (Importante: saida antes de entrada!)
            saida = new ObjectOutputStream(socket.getOutputStream());
            entrada = new ObjectInputStream(socket.getInputStream());

            // 3. SUCESSO: ABRE O NOVO FRAME E PASSA OS OBJETOS DE CONEXÃO
            // Cria a instância do novo frame usando o NOVO CONSTRUTOR
            ClienteJogador2 frameJogador = new ClienteJogador2(socket, saida, entrada);

            // Torna o novo Frame visível
            frameJogador.setVisible(true);

            // Fecha/libera o Frame atual de Login
            this.dispose(); 
